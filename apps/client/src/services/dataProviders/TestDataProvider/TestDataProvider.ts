...
export class TestDataProvider implements DataProvider {
  ...
  dtt = {
    ...
    queryFn: async (date: string) => [
      {
        start: DateTime.fromISO("2023-09-20T09:00:00").toJSDate(),
        end: DateTime.fromISO("2023-09-20T10:00:00").toJSDate(),
      ...
      {
        start: DateTime.fromISO("2023-09-20T10:05:00").toJSDate(),
        end: DateTime.fromISO("2023-09-20T11:05:00").toJSDate(),
      ...
      {
        start: DateTime.fromISO("2023-09-20T11:10:00").toJSDate(),
        end: DateTime.fromISO("2023-09-20T11:40:00").toJSDate(),
  ...
  notices = {
    queryFn: async () => [
      {
        date: DateTime.fromISO("2023-09-20T00:00:00").toJSDate(),
        title: "Test Notice",
      ...
      {
        date: DateTime.fromISO("2024-04-01T00:00:00").toJSDate(),
        title: "Test Notice 2",
